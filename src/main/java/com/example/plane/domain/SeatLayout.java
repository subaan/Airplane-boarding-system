...
public class SeatLayout {
    ...
    private List<SeatLayoutGroup> seatLayoutGroups;
     ...
     */
    public List<SeatLayoutGroup> getSeatLayoutGroups() {
     ...
     */
    public void setSeatLayoutGroups(List<SeatLayoutGroup> seatLayoutGroups) {
